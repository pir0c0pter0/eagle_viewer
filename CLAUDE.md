...
Known TODOs (pre-existing parity gaps): octagon/long pad shapes, package text rendering, EAGLE spin flag (`rot="SMR0"` renders with wrong mirror/rotation).
